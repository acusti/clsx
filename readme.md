...
> A tiny (234B) utility for constructing `className` strings conditionally.<Br>Also serves as a [faster](../blob/master/bench) & smaller drop-in replacement for the `classnames` module.
